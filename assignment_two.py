...
print("Oh, " + place + ", it is a beautiful place. "
                       "I wish I can visit there someday, but I can only stay in this computer.")
# Get the user's age
...
rate = input("And what would be the annual interest rate to buy this house? "
             "You don't need to write down the percent sign, I will deal with it for ya.")
